...
|  PHP | Mssql Version            | SO | CI-Actions
|:----:|:------------------------:|:--:|:---:|
|![PHP-7](https://img.shields.io/badge/7:latest-blue) | ![Mssql-2017](https://img.shields.io/badge/server2017:latest-blue) ![Mssql-2017](https://img.shields.io/badge/server2019:latest-blue)|![Linux](https://img.shields.io/badge/ubuntu-blue)|[![Build status](https://github.com/yiisoft/db-mssql/workflows/build/badge.svg)](https://github.com/yiisoft/db-mssql/actions?query=workflow%3Abuild) [![Mutation testing badge](https://img.shields.io/endpoint?style=flat&url=https%3A%2F%2Fbadge-api.stryker-mutator.io%2Fgithub.com%2Fyiisoft%2Fdb-mssql%2Fmaster)](https://dashboard.stryker-mutator.io/reports/github.com/yiisoft/db-mssql/master) [![static analysis](https://github.com/yiisoft/db-mssql/workflows/static%20analysis/badge.svg)](https://github.com/yiisoft/db-mssql/actions?query=workflow%3A%22static+analysis%22)
