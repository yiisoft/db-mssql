...
final class ConvertionProvider
{
    public static function castColumns(): array
    {
        return [
            ...
            ['Mycast5', 'datetime', 'DateTimeInterface', new Expression('CONVERT([datetime],\'2023-02-21\')')],
    ...
    public static function convertColumns(): array
    {
        return [
            ...
            ['Myconvert5', 'datetime', 'DateTimeInterface', new Expression('CONVERT([datetime],\'2023-02-21\')')],
    ...
    public static function tryCastColumns(): array
    {
        return [
            ...
            ['Mytrycast5', 'datetime', 'DateTimeInterface', new Expression('TRY_CAST(\'2023-02-21\' AS [datetime])')],
    ...
    public static function tryConvertColumns(): array
    {
        return [
            ...
            ['Mytryconvert5', 'datetime', 'DateTimeInterface', new Expression('TRY_CAST(\'2023-02-21\' AS [datetime])')],
