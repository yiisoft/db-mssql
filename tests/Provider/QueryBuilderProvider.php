    ...
    public static function insertWithReturningPks(): array
    {
        return [
            ...
            'params-and-expressions' => [
                ...
                [],
                <<<SQL
                SET NOCOUNT ON;DECLARE @temporary_inserted TABLE ([int_col] int , [int_col2] int NULL, [tinyint_col] tinyint NULL, [smallint_col] smallint NULL, [char_col] char(100) , [char_col2] varchar(100) NULL, [char_col3] text NULL, [float_col] decimal(4,3) , [float_col2] float NULL, [blob_col] varbinary(MAX) NULL, [numeric_col] decimal(5,2) NULL, [smalldatetime_col] smalldatetime , [datetime_col] datetime , [datetime2_col] datetime2(2) , [datetimeoffset_col] datetimeoffset(7) , [date_col] date , [time_col] time(6) , [datetime2_default] datetime2(7) , [bool_col] tinyint , [bool_col2] tinyint NULL);INSERT INTO {{%type}} ([related_id], [time]) OUTPUT INSERTED.[int_col],INSERTED.[int_col2],INSERTED.[tinyint_col],INSERTED.[smallint_col],INSERTED.[char_col],INSERTED.[char_col2],INSERTED.[char_col3],INSERTED.[float_col],INSERTED.[float_col2],INSERTED.[blob_col],INSERTED.[numeric_col],INSERTED.[smalldatetime_col],INSERTED.[datetime_col],INSERTED.[datetime2_col],INSERTED.[datetimeoffset_col],INSERTED.[date_col],INSERTED.[time_col],INSERTED.[datetime2_default],INSERTED.[bool_col],INSERTED.[bool_col2] INTO @temporary_inserted VALUES (:qp0, now());SELECT * FROM @temporary_inserted;
                SQL,
                [':qp0' => null],
            ],
            'carry passed params' => [
